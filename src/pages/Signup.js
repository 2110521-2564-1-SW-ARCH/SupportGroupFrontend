    ...
    const drawer = (
        <div style={{ height: "90%" }}>
            ...
            <center>
                ...
                <br />
                <Button disabled={email === '' || password === '' || confirmPassword === '' || (password !== confirmPassword)} onClick={() => dispatch(signup({ email, password }))} variant="contained" className={classes.button}>
                    Sign up
                </Button>
            </center>
        </div >
